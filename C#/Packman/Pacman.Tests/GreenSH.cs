...
namespace Pacman.Tests
{
    public class GreenSH
    {
        ...
        public GreenSH(MapTest map, Coord coord)
        {
            unitNumber = 7;
            Coord = coord;
            map.map[coord.X, coord.Y] = 7;
        }
        ...
        public void RedrowUnit(GreenSH unit, RememberStepObject obj)
        {
        ...
        public void RedrowUnitToNewPosition(GreenSH unit, Coord newCoord)
        {
            DrawSymbol(unit.Coord, new Sprite(0, " "));
        ...
        public void Move(MapTest map)
        {
            ...
            if (eat == null)
            {
                ...
                else if (map.map[NextCoord.X, NextCoord.Y] == 6)
                    eat = new RememberStepObject(NextCoord, 6, new Sprite(0, ""));
